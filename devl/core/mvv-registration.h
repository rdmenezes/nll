...
public:
   ...
   virtual RuntimeValue run( const std::vector<RuntimeValue*>& args )
   {
      ...
      nll::algorithm::AffineRegistrationCT3d registration;
      nll::core::Matrix<double> tfm;
      nll::algorithm::AffineRegistrationCT3d::Result result = registration.process( *vol1, *vol2, tfm, false );
      if ( result == nll::algorithm::AffineRegistrationCT3d::FAILED_TOO_LITTLE_INLIERS )
      {
         throw std::runtime_error( "Registration failed: Insufficient inliers" );
      }
      if ( result != nll::algorithm::AffineRegistrationCT3d::SUCCESS )
      {
