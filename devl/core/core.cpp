...
void importFunctions( CompilerFrontEnd& e, mvv::platform::Context& context )
{
   ...
   */
...

   {
      ...
      const AstDeclFun* fn = e.getFunction( nll::core::make_vector<platform::Symbol>( platform::Symbol::create( "ToolAnnotations"), platform::Symbol::create( "add" ) ), nll::core::make_vector<const Type*>( vector3f, vector3f, new TypeString( false ), vector3i ) );
      assert( fn );
