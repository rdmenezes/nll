...
namespace platform
{
   ...
   {
   public:
      ToolManipulatorsPoint( const nll::core::vector3f& position, const std::string& txt, Font& font, ui32 txtSize = 12, nll::core::vector3uc color = nll::core::vector3uc( 255, 255, 255 ), double distanceToDisplay = 0 ) : _position( position ), _color( color ), _txt( txt ), _font( font ), _txtSize( txtSize ), _distanceToDisplay( distanceToDisplay )
      {
